...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("11/12/2023 23:00:00");
  ...
  (currentTimeHtml =
    ...
    : `<div style="font-size:13px;font-weight:bold">下班了就该开开心心地玩耍~<br> 本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`;    document.getElementById("workboard") &&
